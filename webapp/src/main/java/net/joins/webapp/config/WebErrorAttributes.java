...
public class WebErrorAttributes extends DefaultErrorAttributes {
    ...
    @Override
    public Map<String, Object> getErrorAttributes(WebRequest webappRequest, boolean includeStackTrace) {
        Map<String, Object> result = super.getErrorAttributes(webappRequest, includeStackTrace);
